  ...
  return (
    <>
      {articles && articles.length !== 0 && articles[0] ? (
        ...
        <div className="prose dark:prose-invert prose-img:m-0 prose-h3:mt-0 prose-p:m-0 container grid w-full grid-cols-1 gap-6 px-4 py-8 md:grid-cols-2 md:px-6 lg:grid-cols-3 lg:px-8">
